...
{{- if .Values.customCA }}
server_tls_ca_file = /bitnami/pgbouncer/conf/server-ca-certificates.crt
{{- else }}
...
auth_file = /bitnami/pgbouncer/conf.d/userlist.txt
;auth_hba_file =
...
;job_name = pgbouncer
;%include /bitnami/pgbouncer/conf/pgbouncer-other.ini
